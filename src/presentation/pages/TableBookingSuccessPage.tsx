...
import { TableBookingSuccessPageContent } from "../components/TableBookingSuccessPage";

const TableBookingSuccessPage = () => {
  return (
    <Page className="page-content relative flex flex-1 flex-col bg-green6">
      ...
      <div className="flex-1 overflow-auto bg-[#F8F8F8]">
        <TableBookingSuccessPageContent />
      </div>
    </Page>
  );
};

export default TableBookingSuccessPage;
