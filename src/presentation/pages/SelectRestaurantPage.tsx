...
import { SelectRestaurantPageContent } from "../components/SelectRestaurantPage";
...
const SelectRestaurantPage = () => {
  return (
    <Page className="page-content relative flex flex-1 flex-col bg-green6">
        ...
        title={
          (
            <div className="justify-left flex w-[calc(100%-80px)]">
              <div className="text-base text-white">Thông tin chi nhánh</div>
            </div>
      ...
      />
      <div className="flex-1 overflow-auto bg-[#F9F6F6]">
        <SelectRestaurantPageContent />
      </div>
    </Page>
  );
};
