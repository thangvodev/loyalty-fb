...
import { UserDeliveryDetailsPageContent } from "../components/UserDeliveryDetailsPage";

const UserDeliveryDetailsPage = () => {
  return (
    <Page className="page-content relative flex flex-1 flex-col bg-green6">
        ...
        title={
          (
            <div className="justify-left flex w-[calc(100%-80px)]">
              <div className="text-base text-white">Thông tin giao hàng</div>
            </div>
      ...
      <div className="flex-1 overflow-auto bg-surface1">
        <UserDeliveryDetailsPageContent />
      </div>
    </Page>
  );
};

export default UserDeliveryDetailsPage;
