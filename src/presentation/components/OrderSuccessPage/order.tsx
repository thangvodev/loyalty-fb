  ...
  return (
    <div className="flex flex-col gap-[20px]">
      ...
      <div className="flex flex-col gap-[8px] text-center">
        <div className="text-xl font-semibold">Cảm ơn bạn đã đặt món</div>
        <div className="text-balance text-sm font-normal text-gray7">
          Đơn hàng của bạn sẽ được giao trong 15-20p tới. Vui lòng chú ý điện
          thoại để nhận hàng.
        </div>
      </div>
      ...
      {/* Bonus */}
      <div className="border-orange3 flex items-center justify-center gap-[4px] rounded-[8px] border bg-orange1 px-[8px] py-[10px]">
        <div className="text-orange9 text-xs font-medium">
          Bạn được cộng thêm
        </div>
